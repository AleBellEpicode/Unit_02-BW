...
const renderTrackList = (track, i) => {
   ...
   trackList.innerHTML += `
       <div class="row row-cols-3 mt-3 px-1 py-2 rounded">
          <div class="col col-5 d-flex songcontenitoreperilplay">
            <span class="align-self-center me-4 numerochediventaplay"  song-id="${track.id}" onclick="setPlayer(event)">${i}</span>
